...
public final class AuthConst {
    ...
    public static final String R1 = "1"; 			 // 角色_1_管理员 最高权限，超管身份的代表
    public static final String R2 = "2"; 		 // 角色_2_一般用户
//	public static final String R99 = "99";		  // 进入后台权限，没有此权限无法进入后台管理
    ...
    public static final String USER_INFO = "user-info";		// 用户界面 - 用户获取个人信息权限
